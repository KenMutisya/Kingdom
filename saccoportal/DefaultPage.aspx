      ...
      <asp:MultiView ID="MultiViewLoadLogins" runat="server"> 
                ...
                <asp:View ID="individualLogin" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <span class="pull-right"><asp:LinkButton runat="server" ID="lnkbtnCreateAcc" OnClick="lnkbtnCreateAcc_Click" CausesValidation="False">Create an Account</asp:LinkButton></span>
                        </div>
                    </div>
                    <br />
                ...
                <asp:View ID="jointLogin" runat="server">
                    ...
                    <br />                   
                    <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-user"></i> Account No:</span>
                    <asp:TextBox ID="TextAccountno" runat="server" CssClass="form-control" placeholder="Member number"></asp:TextBox>
                    </div>
                    <br />
                    <div class="input-group">
               ...
               <asp:View ID="JointResetView" runat="server">
                        <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i> Account  No:</span>
                        <asp:TextBox ID="txtAccountno" runat="server" CssClass="form-control" placeholder="Enter Member Number" ></asp:TextBox>
                        </div>
                        <br />
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-id-card"></i> National ID:</span>
                            <asp:TextBox ID="txtidNo" runat="server" CssClass="form-control" placeholder="Enter ID Number" ></asp:TextBox>                   
                        </div>
                        <br /> 
                         <div class="row">
                            <div class="col-md-12">
